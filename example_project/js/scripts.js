...
function chart(column, filterBy, groupBy) {
    ...
    d3.csv("/data/co2-population.csv", function(data) {
                ...
                d.values.forEach(function(f) {
                    ...
                    if (xDate == year) {
                        tooltip
                            ...
                            .html("<div class='year'>" + year + "</div><div class='key'><div style='background:" + color + "' class='swatch'>&nbsp;</div>" + f.key + "</div><div class='value'>" + f.value.toFixed(2) + " MMTCO2 </div>")
